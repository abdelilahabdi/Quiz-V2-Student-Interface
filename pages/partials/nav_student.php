        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <span class="ml-3 px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-full">Étudiant</span>
                </div>
                ...
                <div class="hidden md:ml-10 md:flex md:space-x-8">
                    ...
                    <a href="<?= $basePath ?>student/dashboard.php" 
                       class="<?= ($currentPage ?? '') === 'dashboard' ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        <i class="fas fa-home mr-2"></i>Accueil
                    </a>
                    
                    <!-- Catégories -->
                    <a href="<?= $basePath ?>student/categories.php" 
                       class="<?= ($currentPage ?? '') === 'categories' ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                        <i class="fas fa-folder-open mr-2"></i>Catégories
                    </a>
                    
                    <!-- Mes Résultats -->
                    <a href="<?= $basePath ?>student/my_results.php" 
                       class="<?= ($currentPage ?? '') === 'results' ? 'border-blue-500 text-gray-900' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700' ?> inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
